...
class PrivateReject extends StatefulWidget {
  final Map application;
  const PrivateReject({super.key, required this.application});

  @override
  State<PrivateReject> createState() => _PrivateRejectState();
}

class _PrivateRejectState extends State<PrivateReject> {
